...
install_frontend: up ## Install all dependecies frontend
	...
	@docker-compose exec cate-app npm run build-storybook
	@docker-compose exec cate-app npm run prod

storybook: up ## Watch storybook
	@echo "\n>> Watch storybook changes\n"
	@docker-compose exec cate-app npm run storybook

watch_frontend: up ## Watch file changes on frontend
	@echo "\n>> Watch node changes\n"
	@docker-compose exec cate-app npm run watch

test_frontend: up ## Test file changes on frontend
	@echo "\n>> Testing components\n"
	@docker-compose exec cate-app npm run test:unit
